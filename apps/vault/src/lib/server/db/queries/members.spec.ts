        ...
        bind: (...bindParams: any[]) => {
          ...
          return {
            all: async () => {
              ...
              if (
                sql.includes("member_sections ms") &&
                sql.includes("ms.member_id = ?")
              ) {
              ...
              // Member voices query
              if (
                sql.includes("member_voices mv") &&
                sql.includes("mv.member_id = ?")
              ) {
              ...
              if (
                sql.includes("invite_sections isc") &&
                sql.includes("isc.invite_id = ?")
              ) {
              ...
              // Invite voices query
              if (
                sql.includes("invite_voices iv") &&
                sql.includes("iv.invite_id = ?")
              ) {
                const [inviteId] = params;
